...
import numpy as np
from utils import guess_gaussian_parameters
...
def make_master_sky(object_list, flat_darkcor_sigmacut_data, datadir):
    ...
    for time in exposuretimes:
        ...
        skycubelist = np.concatenate([toprt[0:min_dither], toplft[0:min_dither], btmrt[0:min_dither], btmlft[0:min_dither], center[0:min_dither]])
